...
// const targetVersion = "1.9.9.25.2";
//
// class DeployObject {
//   File pomFile;
//   File aarFile;
...
//   {
//     // 修改自身的版本号
//     final xml.XmlText versionNode = doc.findAllElements("version").first.firstChild;
...
//       final xml.XmlText versionNode = element.findElements("version").first.firstChild;
...
//     '-Durl="http://10.2.4.144:8081/repository/maven-releases"',
//     '-DrepositoryId="nexus"',
//     '-Dpackaging=aar',
//     '-s="$configPath"',
//   ];
...
//
//   final f = File("${Directory.systemTemp.path}\\${DateTime.now().microsecondsSinceEpoch}.sh");
//
